...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="op-v-item"><a class="op-v-link" href="#animaux">Mes animaux</a></li>
        ...
        <?PHP
        require_once("./tarif/visualiser.php");
        require_once("./contact/formulaire.php");
        require_once("./gestion_animal/visualiser.php");
        require_once("./hospitaliser/visualiser.php");
        require_once("./profil/visualiser.php");
        ?>
 <hr>

...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="op-v-item"><a class="op-v-link" href="#medicament">Médicaments</a> </li>
                    <li class="op-v-item"><a class="op-v-link" href="#prescription">Prescriptions</a></li>
                    <li class="op-v-item"><a class="op-v-link" href="#client">Propriétaires</a></li>
                    <li class="op-v-item"><a class="op-v-link" href="#suivi">Suivi à distance</a></li>
        ...
        include("./medicament/visualiser.php");
        include("./prescription/visualiser.php");
        include("./gestion_user/visualiser.php");
        include("./hospitaliser/visualiser.php");
